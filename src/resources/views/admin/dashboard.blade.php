...
<div class="px-4 sm:px-0">
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">GitHub訪問数集計システムの概要</p>
    </div>
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="flow-root">
                <ul class="-my-5 divide-y divide-gray-200">
                        ...
                        <li class="py-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900 truncate">{{ $repo->full_name }}</p>
                                    <p class="text-sm text-gray-500">{{ $repo->created_at->format('Y年m月d日 H:i') }}に登録</p>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $repo->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                        {{ $repo->is_active ? 'アクティブ' : '非アクティブ' }}
                                    </span>
                                </div>
                            </div>
                        </li>
                    @empty
                        <li class="py-4">
                            <p class="text-sm text-gray-500">まだリポジトリが登録されていません。</p>
                        </li>
                    @endforelse
                </ul>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-gray-900">フォロワー統計</h4>
                            <p class="text-sm text-gray-500">フォロワー数の推移と統計情報</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('github.followers') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                            統計を表示
                        </a>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-gray-900">フォロワー詳細</h4>
                            <p class="text-sm text-gray-500">個別フォロワーの詳細情報</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('github.follower-details') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                            詳細を表示
                        </a>
                    </div>
                </div>
