# GitHub Analytics Laravel プロジェクト構成ドキュメント
...
#### 1. app (PHP-FPM)
- **コンテナ名**: `github-analytics-backend`
...
#### 5. phpmyadmin
- **コンテナ名**: `github-analytics-phpmyadmin`
- **機能**:
  - データベース管理UI
  - ポート: 8091
